...
const CollapsibleLegend = ({
  ...
  return (
    <div className="relative">
      {/* Parent container for legend and tab */}
      <div
        ...
        style={{
          width: "200px",
          overflow: "hidden",
          zIndex: 1, // Ensures the legend stays above other content
          right: isOpen ? "0" : "-200px", // Shifts legend and tab together
        }}
      >
        {/* Legend content */}
        ...
        {/* Tab button attached to the right edge of the legend container */}
        <button
