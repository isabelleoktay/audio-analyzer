...
const CollapsibleLegend = ({
  ...
  return (
    <div className="relative">
      <button
        className="absolute top-0 left-0 py-2 px-1 text-lg text-white font-semibold border-none bg-blue-500 rounded-r-lg transition ease-in-out delay-50 bg-opacity-50 hover:bg-opacity-75"
        style={{
      ...
      <div
        className={`absolute top-0 left-0 h-full bg-blue-50 rounded-lg border-2 border-blue-300 border-solid transition-transform duration-300 ${
