...
const CollapsibleLegend = ({
  ...
  return (
    <div className="relative">
      {/* Container for the legend and the tab */}
      <div className="relative">
        {/* Collapsible Legend */}
        <div
        ...
        {/* The tab button (rotated and positioned on the right side) */}
        <button
          className="absolute top-0 right-0 py-2 px-1 text-lg text-white font-semibold border-none bg-blue-500 transition ease-in-out delay-50 bg-opacity-50 hover:bg-opacity-75"
          style={{
            writingMode: "vertical-rl", // Rotate the text 90 degrees
            transform: "rotate(180deg)", // Flip the tab 180 degrees
            height: "100%", // Make the tab stretch the full height of the legend
            zIndex: 2, // Ensure the tab stays on top
          }}
