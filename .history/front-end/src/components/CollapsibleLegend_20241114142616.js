...
const CollapsibleLegend = ({
  ...
  return (
    <div className="relative">
      ...
      <button
        className="absolute top-0 right-[-50px] py-2 px-1 flex-grow text-lg text-white font-semibold border-none bg-blue-500 rounded-l-lg transition ease-in-out delay-50 bg-opacity-50 hover:bg-opacity-75"
        style={{
