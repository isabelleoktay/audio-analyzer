    ...
    <div className="relative flex">
      ...
      >
        ...
        <div className="flex h-full">
          ...
          <button
            className="w-12 flex items-center justify-center text-lg text-white font-semibold bg-blue-500 rounded-l-lg transition ease-in-out bg-opacity-50 hover:bg-opacity-75"
            style={{
