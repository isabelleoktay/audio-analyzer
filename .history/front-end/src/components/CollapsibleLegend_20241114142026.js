...
const CollapsibleLegend = ({
  ...
  return (
    <div className="relative">
      ...
      >
        {/* Tab button inside the legend container */}
        <button
          className="absolute top-1/2 transform -translate-y-1/2 right-0 py-2 px-1 text-lg text-white font-semibold border-none bg-blue-500 rounded-l-lg transition ease-in-out delay-50 bg-opacity-50 hover:bg-opacity-75"
          style={{
            transform: "rotate(90deg) translateX(50%)", // Rotate the tab and position it correctly
            transformOrigin: "top left", // Keeps rotation from affecting layout unexpectedly
