...
const AudioAnalyzer = () => {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-gray-100">
      ...
      {/* Main Content */}
      <div className="flex flex-col items-center w-4/5 h-full flex-2">
        ...
        {/* Display Highlighted Audio or Normalized Variability*/}
        {audioBuffer &&
          features &&
          waveformAxes &&
          highlightedSections &&
          (() => {
            ...
            if (activeVisualizationTab === "Highlights") {
              ...
              highlightedSectionsData = highlightedSections.filter((section) =>
            ...
            return (
              <div className="w-full flex flex-row space-x-6 h-[300px]">
                ...
                <div className="p-4 mt-8 bg-blue-50 rounded-lg border-2 border-blue-300 border-solid relative w-full">
