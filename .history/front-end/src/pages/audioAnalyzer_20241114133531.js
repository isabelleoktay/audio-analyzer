        ...
        <div className="flex flex-col h-full w-full xl:w-3/5 lg:w-3/4 mt-4 flex-grow py-4 space-y-4">
          ...
          <div className="flex flex-row space-x-6 h-[300px]">
            ...
            <div className="flex flex-col justify-start items-center w-8">
              <button
                className={`py-2 px-1 flex-grow text-lg text-white font-semibold border-none bg-blue-500 rounded-t-lg ${
              ...
              <button
                className={`py-2 px-1 flex-grow text-lg text-white font-semibold border-none bg-blue-500 rounded-b-lg ${
