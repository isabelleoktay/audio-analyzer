...
import ButtonNoOutline from "../components/ButtonNoOutline";
      ...
      {!file ? (
        ...
        <div className="flex flex-col mt-8 xl:w-3/5 lg:w-3/4 p-4 bg-blue-100 rounded-lg border-2 border-blue-300 border-solid">
          <div className="flex items-center mb-1">
            ...
            {/* <button
              onClick={removeFile}
              className={`ml-auto hover:cursor-pointer transition ease-in-out delay-50 text-xs text-center text-white hover:text-white text-sm border-transparent focus:border-transparent focus:ring-0 focus:outline-none bg-red-500 hover:bg-red-400 py-1 px-2 outline-none rounded`}
            >
              Remove File
            </button> */}
          </div>
