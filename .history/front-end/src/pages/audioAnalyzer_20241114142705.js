        ...
        <div className="flex flex-col h-full w-full xl:w-3/5 lg:w-3/4 mt-4 flex-grow py-4 space-y-4">
          ...
          <div className="flex flex-row h-[300px]">
            ...
            <CollapsibleLegend
              ...
              selectedHighlightedSections={selectedHighlightedSections}
              togglePlayingSection={togglePlayingSection}
              handleHighlightedSectionSelect={handleHighlightedSectionSelect}
              playingSection={playingSection}
            />
          ...
          <div className="flex flex-row h-[300px]">
            ...
            {/* Graph Display */}
            <div className="p-4 bg-blue-50 rounded-r-lg border-2 border-blue-500 border-solid z-40 relative w-full">
